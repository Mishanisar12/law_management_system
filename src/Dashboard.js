                                            ...
                                            <div className="card-body">
                                                <div className="row no-gutters ">
                                                    ...
                                                    <div className="col-auto">
                                                        <i class="fa-solid fa-user-nurse fa-3x text-gray-400"></i>
                                        ...
                                        <div className="card border-left-primary shadow  py-2">
                                            <div className="card-body">
                                                <div className="row no-gutters ">
                                                    ...
                                                    <div className="col-auto">
                                                        <i class="fa-solid fa-star fa-3x text-gray-400"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="card-body">
                                                <div className="row no-gutters ">
                                                    ...
                                                    <div className="col-auto">
                                                        ...
                                                        <i class="fa-regular fa-file-zipper fa-3x text-gray-400"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
