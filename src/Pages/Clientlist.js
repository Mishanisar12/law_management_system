  ...
  <section className="table__header">
    ...
    <div className="export__file">
      ...
      <div className="export__file-options">
        ...
        <label htmlFor="export-file" id="toPDF">PDF <img src={img} alt /></label>
        <label htmlFor="export-file" id="toJSON">JSON <img src={img} alt /></label>
        <label htmlFor="export-file" id="toCSV">CSV <img src={img} alt /></label>
        <label htmlFor="export-file" id="toEXCEL">EXCEL <img src={img} alt /></label>
      </div>
    </div>
  </section>
  <section className="table__body">
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td> 2 </td>
          <td><img src={img} alt /> Jeet Saru </td>
          <td> Kathmandu </td>
          <td> 27 Aug, 2023 </td>
          <td>
        ...
        <tr>
          <td> 3</td>
          <td><img src={img} alt /> Sonal Gharti </td>
          <td> Pakistan </td>
          <td> 14 Mar, 2023 </td>
          <td>
        ...
        <tr>
          <td> 4</td>
          <td><img src={img} alt /> Alson GC </td>
          <td> Lahore </td>
          <td> 25 May, 2023 </td>
          <td>
            <p className="status delivered">OK</p>
        ...
        <tr>
          <td> 5</td>
          <td><img src={img} alt /> Sarita Limbu </td>
          <td> Karachi </td>
          <td> 23 Apr, 2023 </td>
          <td>
        ...
        <tr>
          <td> 6</td>
          <td><img src={img} alt /> Alex Gonley </td>
          <td> Islamabad </td>
          <td> 23 Apr, 2023 </td>
          <td>
        ...
        <tr>
          <td> 8</td>
          <td><img src={img} alt /> Aayat Ali Khan </td>
          <td> Islamabad </td>
          <td> 30 Feb, 2023 </td>
          <td>
            <p className="status pending">Pending</p>
